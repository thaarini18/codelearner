...
(function () {
  ...
  const prismjs = function (global, module, exports) {
    ...
    Prism.languages.mips = {
      ...
      'variable': /\$(?:[0-2]?\d|3[01]|zero|at|v[01]|a[0-3]|t[0-9]|s[0-7]|k[01]|gp|sp|fp|ra)/,
      'function': /\b(?:add|addi|addiu|addu|and|andi|beq|bgez|bgezal|bgtz|blez|bltz|bltzal|bne|div|divu|j|jal|jalr|jr|lb|lbu|lh|lhu|lui|lw|lwc1|lwl|lwr|mfc0|mfhi|mflo|mtc0|mthi|mtlo|mult|multu|nor|or|ori|sb|sc|sh|sll|sllv|slt|slti|sltiu|sltu|sra|srav|srl|srlv|sub|subu|sw|swc1|swl|swr|syscall|teq|teqi|tge|tgei|tgeiu|tgeu|tlt|tlti|tltiu|tltu|tne|tnei|xor|xori|li|la|move|nop)\b/i,
      'symbol': /\b\w+(?=:)/,
